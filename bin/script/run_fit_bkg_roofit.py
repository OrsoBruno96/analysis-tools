...
subranges = [
    {
        ...
        'bins': 1000,
        'name': "first",
        'pars_filename': "../_tmp/fit/roo_init_pars_supernovo_first.txt",
        'pars': pars
    },
    {
        'min': 400,
        ...
        'bins': 300,
        'name': "second",
        'pars_filename': "../_tmp/fit/roo_init_pars_supernovo_second.txt",
        'pars': pars
    },
    {
        'min': 800,
        ...
        'bins': 50,
        'name': "third",
        'pars_filename': "../_tmp/fit/roo_init_pars_supernovo_third.txt",
        'pars': pars
    },
]
